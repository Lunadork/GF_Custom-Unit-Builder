//This is going to be a pain to code. Maybe do a switch statement on calc property instead, have calc be an integer that refers to a cost ruleset....  Will keep this for easier reference at least.
const specialRules = [
